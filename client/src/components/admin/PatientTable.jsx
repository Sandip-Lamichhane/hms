...
export default function PatientTable({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white border border-[#c8eedc] p-4 rounded-2xl shadow-xl">
        <div className="relative flex-1 max-w-md">
          ...
          <input
            ...
            className="w-full bg-[#fbfdfc] border border-[#c8eedc] rounded-xl pl-10 pr-4 py-2 text-xs text-slate-900 placeholder-slate-500 focus:outline-none focus:border-emerald-500"
          />
        </div>

        <button
          onClick={openCreateModal}
          className="inline-flex items-center justify-center gap-2 px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-slate-900 text-xs font-bold shadow-lg shadow-emerald-950/60 transition-all cursor-pointer shrink-0"
        >
                  ...
                  <tr key={rec.id} className="hover:bg-emerald-50/30 transition-colors">
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-2.5">
                        <div className="w-8 h-8 rounded-full bg-slate-800 border border-[#c8eedc] flex items-center justify-center text-emerald-400 font-bold text-xs shrink-0">
                    ...
                    <td className="px-5 py-4 text-right">
                      <div className="flex items-center justify-end gap-1.5">
                        <button
                          ...
                          className="p-1.5 text-slate-500 hover:text-emerald-400 hover:bg-emerald-50 rounded-lg transition-colors"
                          title="Edit Record"
                        >
                        ...
                        <button
                          ...
                          className="p-1.5 text-slate-500 hover:text-red-400 hover:bg-emerald-50 rounded-lg transition-colors"
                          title="Delete Record"
                        >
          ...
          <div className="px-5 py-3.5 border-t border-[#c8eedc] flex items-center justify-between text-xs text-slate-500">
            ...
            <div className="flex items-center gap-1.5">
              <button
                ...
                className="px-2.5 py-1 rounded bg-slate-800 hover:bg-slate-100 disabled:opacity-40 text-slate-900"
              >
                Prev
              </button>
      ...
      {modalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#fbfdfc] backdrop-blur-sm animate-in fade-in">
            ...
            <form onSubmit={handleSubmit} className="p-5 space-y-4 text-xs">
              ...
              <div className="flex items-center justify-end gap-2.5 pt-2 border-t border-[#c8eedc]">
                <button
                  type="button"
                  onClick={() => setModalOpen(false)}
                  className="px-4 py-2 rounded-xl bg-slate-800 hover:bg-slate-100 text-slate-900 font-bold"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="px-5 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-slate-900 font-bold shadow-lg shadow-emerald-950/60 flex items-center gap-1.5"
                >
