            ...
            {fields.map(({ key, label, type = 'text', required, colSpan }) => (
              <div key={key} className={colSpan === 2 ? 'col-span-2' : ''}>
                ...
                <input
                  ...
                  className="w-full bg-slate-800 border border-[#c8eedc] rounded-xl px-3 py-2.5 text-sm text-slate-900 placeholder-slate-600 focus:outline-none focus:border-indigo-500 transition-colors"
                />
              </div>
            ))}
          </div>
          {!isEdit && (
            <p className="text-xs text-slate-500 mt-4 bg-slate-800/60 p-3 rounded-xl border border-[#c8eedc]/60 leading-relaxed">
    ...
    <SuperAdminLayout>
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#167a68] hover:bg-[#116253] text-slate-900 text-sm font-medium transition-colors shadow-lg shadow-indigo-500/20"
        >
      ...
      <div className="relative mb-6">
        ...
        <input
          ...
          className="w-full bg-white border border-[#c8eedc] rounded-xl pl-10 pr-4 py-2.5 text-sm text-slate-900 placeholder-slate-600 focus:outline-none focus:border-indigo-500 transition-colors"
        />
        {search && (
